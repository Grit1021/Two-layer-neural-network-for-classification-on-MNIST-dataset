...
class Activator():
    ...
    @classmethod #add functions to deal with the data/useful methods
...
class Network():
    ...
    def backprop(self, dx):
        ...
        for i in range(len(self.acts)-1, -1, -1):
            ...
            # Dense Layer Derivative(gradinet calculation)
    ...
    def update(self, lr):
        '''update the parameters(learning rate) by SGD'''
    ...
    def compute_loss(self, pred, fact, batch_size, loss_func = 1):
        '''
        loss function
        '''
        # compute loss
        ...
        if loss_func == 0:   # MSE
            ...
            v = -1. / batch_size * np.sum(fact*np.log(pred))
    ...
    def fit(self, x, y, epochs = 1, batch_size = 40, loss_func = 'CE',
        ...
        loss_func = {'MSE': 0, 'CE': 1}[loss_func]
        ...
        for epoch in range(1, 1 + epochs):
            ...
            for _ in tqdm(range(n // batch_size)):
                ...
                # compute loss(include regularization)
